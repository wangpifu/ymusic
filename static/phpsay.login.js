$(document).ready(function()
{
	...
	if (connect == "")
	{
		$(".artistlogin").click(showLoginViewA);

		$(".emaillogin").click(showLoginViewU);
...
function showLoginViewA()
{
	$("#loginSelect").fadeOut();
	
	$("#loginView").fadeIn();

	$(".secret").attr("value","artist");
...
function showLoginViewU()
{
	$("#loginSelect").fadeOut();
	
	$("#loginView").fadeIn();

	$(".secret").attr("value","user");
